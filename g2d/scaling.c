...
#include <stdbool.h>  // Include stdbool.h for bool, true, and false
...
void reshape(int width, int height) {  
    ...
    gluPerspective(60, (GLfloat)width / (GLfloat)height, 1.0, 100.0); // Set the Field of view angle (in degrees), the aspect ratio of our window, and the near and far planes  
