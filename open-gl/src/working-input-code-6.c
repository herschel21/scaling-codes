...
// Render loop with corrected FPS calculation
void render_loop() {
    ...
    clock_gettime(CLOCK_MONOTONIC, &loop_start_time); // Start time of the entire loop
    ...
    clock_gettime(CLOCK_MONOTONIC, &loop_end_time); // End time of the entire loop
